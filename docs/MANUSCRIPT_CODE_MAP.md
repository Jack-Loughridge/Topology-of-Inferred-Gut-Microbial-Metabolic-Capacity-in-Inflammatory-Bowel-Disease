...
| Frozen external prediction | `external_validation/serrano_gomez/scripts/apply_frozen_h0_alphapi_ensemble_external_ibd_v1.py`; `apply_frozen_ricci_ibd_model_v1.py`; `apply_frozen_species_benchmarks_external_ibd_v1.py` | external features and frozen source models | external predictions and evaluation tables | Moderate |
| External v2 expanded-community analysis | `external_validation/serrano_gomez/scripts/build_expanded_external_v2.py` | completed external profiles and expanded-community prerequisites | v2 graphs, H0, full Ricci, vectors, exploratory transfer tables | Very heavy CPU |
