...
| Table 6, active-vertex directed clustering | `analysis/graph_diagnostics/directed_clustering_participant_average.py` | sample weighted directed graphs and metadata | corrected local summary and LaTeX table; final aggregate pending production rerun | Moderate CPU |
