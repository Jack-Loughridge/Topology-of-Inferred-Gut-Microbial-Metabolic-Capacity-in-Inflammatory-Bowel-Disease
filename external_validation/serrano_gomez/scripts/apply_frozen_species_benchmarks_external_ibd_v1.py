...
BENCHMARK_ROOT = BASE / "Species_Benchmarks_RepeatedCV_IBD_CompleteCase"
...
DEFAULT_OUTPUT_DIR = STRUCTURAL_V1 / "external_species_benchmarks_ibd_vs_nonibd_v1"
...
def main() -> None:
    ...
    provenance = {
        ...
        "analysis": "Serrano-Gomez structural-frozen-IBDMDB v1 external species benchmarks",
